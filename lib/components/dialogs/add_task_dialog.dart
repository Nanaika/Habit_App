...
import 'package:habit_app/components/task_page/tab_bar_task_type.dart';
...
class _AddTaskDialogState extends State<AddTaskDialog> with SingleTickerProviderStateMixin {
  ...
  void saveTask(BuildContext context) {
    final task = Task(
        type: TaskType.values[tabController.index], name: nameController.text, date: date, dateCreated: DateTime.now());
